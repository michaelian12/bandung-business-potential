...
<html lang="en">
  <head>
    ...
    <title>Bandung Business Potential - Business Sector</title>
      ...
      <div class="templatemo-sidebar">
        ...
        <nav class="templatemo-left-nav">
          <ul>
            ...
            <li><a href="#" class="active"><i class="fa fa-flag fa-fw"></i>Business Sector</a></li>
          ...
          <div class="templatemo-flex-row flex-content-row">
            <div class="col-1">
              <div class="panel panel-default margin-10">
                <div class="panel-heading"><h2 class="text-uppercase">Add Business Sector Form</h2></div>
                <div class="panel-body">
                  <form action="../libs/business-sector-add.php" method="post" class="templatemo-login-form">
                    <div class="form-group">
                      <label for="inputEmail">Sector</label>
                      <input type="text" class="form-control" name="namaSektor" placeholder="Sector" required="true">
                    </div>
                    <div class="form-group">
                  ...
                  <table class="table table-striped table-bordered templatemo-user-table">
                    <thead>
                      <tr>
                        ...
                        <td><a href="" class="white-text templatemo-sort-by">Sector <span class="caret"></span></a></td>
                        <td>Edit</td>
                        <td>Delete</td>
                      </tr>
                    </thead>
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td><center><a href="business-sector-edit.php?id=<?php echo $row['id_sektor']; ?>" class="templatemo-edit-btn">Edit</a></center></td>
                        <td><center><a href="../libs/business-sector-delete.php?id=<?php echo $row['id_sektor']; ?>" class="templatemo-link"><i class="fa fa-remove fa-fw" style="color:red;"></i></a></center></td>
                      </tr>
                      <?php
                        }
                        mysqli_close($link);
