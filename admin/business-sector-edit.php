      ...
      <div class="templatemo-sidebar">
        ...
        <nav class="templatemo-left-nav">
          <ul>
            ...
            <li><a href="business-sector.php" class="active"><i class="fa fa-flag fa-fw"></i>Business Sector</a></li>
        ...
        <div class="templatemo-content-container">
          <div class="templatemo-flex-row flex-content-row">
            <div class="panel panel-default margin-10 col-1">
              <div class="panel-heading"><h2 class="text-uppercase">Edit Business Sector Form</h2></div>
              <div class="panel-body">
                <?php
                  $link = dbConnect();
                  $sql = "select * from sektor_usaha where id_sektor = '$id_edit'";
                  $res = $link->query($sql);
                  if (mysqli_num_rows($res) == 1) {
                    $data = mysqli_fetch_array($res);
                ?>
                <form action="../libs/business-sector-edit.php?id=<?php echo $id_edit; ?>" method="post" class="templatemo-login-form">
                  <div class="form-group">
                    <label for="inputEmail">Sector</label>
                    <input type="text" class="form-control" name="namaSektor" placeholder="Sector" value="<?php echo $data['nama_sektor']; ?>" required="true">
                  </div>
                  <div class="form-group">
